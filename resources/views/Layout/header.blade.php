<nav class="bg-opacity-[var(--scrollPosition)] bg-black fixed w-full z-20">
    <div>
        <div class="flex flex-wrap p-4 container mx-auto">
            {{-- HAMBURGER ICON --}}
            <div class="w-1/12 md:hidden items-end justify-end">
                <button data-collapse-toggle="navbar-mobile" type="button" class="p-2 w-10 h-10 justify-center text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-language" aria-expanded="false">
