<nav class="bg-opacity-[var(--scrollPosition)] bg-black fixed w-full z-20">

    <div class="flex p-4 mx-auto container">
        {{-- HAMBURGER ICON --}}
        <div class="me-5 lg:hidden">
            <div data-collapse-toggle="navbar-mobile" type="button" class="p-2 w-10 h-10 justify-center text-white rounded-lg cursor-pointer" aria-controls="navbar-language" aria-expanded="false">
        ...
        {{-- NAVIGATION LINKS --}}
        <div class="hidden lg:flex w-full flex-1 md:items-center md:justify-center ">
        ...
        <div class="flex items-center ms-auto">
            <div type="button" data-dropdown-toggle="language-dropdown-menu" class="inline-flex items-center font-medium justify-center px-4 py-2 text-sm text-white hover:text-orange-500">
    ...
    <div class="w-full lg:hidden hidden p-4 container mx-auto" id="mobileNav">
...
<script>
    document.onscroll = (event) => {
        document.documentElement.style.setProperty('--scrollPosition', Math.min(1, window.scrollY / 500));
    }
