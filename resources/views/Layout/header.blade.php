<nav class="bg-transparent fixed w-full z-20">
    ...
    document.querySelector('[data-collapse-toggle="navbar-language"]').addEventListener('click', function() {
        ...
        mobileNav.classList.toggle('hidden');
            ...
            {{-- LANGAUGE SELECTOR --}}
            <div class="flex items-center">
                <button type="button" data-dropdown-toggle="language-dropdown-menu" class="inline-flex items-center font-medium justify-center px-4 py-2 text-sm text-white hover:text-orange-500 ">
